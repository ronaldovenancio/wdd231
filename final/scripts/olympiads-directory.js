...
function displayEachObj(olympiad) {
    ...
    h3.textContent = olympiad.name;
    sh.textContent = olympiad.name_add; // h3
    h4_1.textContent = "Address: ";
    h4_2.textContent = "Phone Number: ";
    h4_3.textContent = "Website URL: ";
    par1.textContent = olympiad.address + ', ' + olympiad.address_end;
    par2.textContent = olympiad.phone;
    par3.textContent = olympiad.url;

    // Build the href attribute for url links.
    par3.setAttribute('href', olympiad.url);

    // Build the image attributes by using the setAttribute method for the src, alt, and loading attribute values. (Fill in the blank with the appropriate variable).
    //image.setAttribute('src', olympiad.logo);
    image.setAttribute('src', olympiad.logo);
    image.setAttribute('loading', 'lazy');
    image.setAttribute('alt', 'Logo of ' + olympiad.name);
