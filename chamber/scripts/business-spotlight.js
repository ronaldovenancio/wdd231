...
function displaySpotlights(choice1, choice2, choice3) {
    ...
    memberLevel1.textContent = "Level Member: " + choice1.mem_lvl;
    ...
    memberLevel2.textContent = "Level Member: " + choice2.mem_lvl;
    ...
    memberLevel3.textContent = "Level Member: " + choice3.mem_lvl;
